...
// 3d self-similar GPE singular solution RK4: Black hole
    
int main()
{
    
    RK4(Zmax, 1./Zmax, -pow(Zmax,-2.), 2.*pow(Zmax,-3.), 1.e-4);
...
void RK4(double v0, double rho0, double drho0, double vel0, double h)
{
    ...
    std::string B_val("B_"), h_val("h_"), folder("3D_self_similar_new_sol/"), rk4("_self_similar_repulsive_BH_rk4"), new_sol("_rho_0.00001_drho_-0.0001_vel_0.01"), file_for_B_r0_val("r0_vs_B2"), extension(".txt");
